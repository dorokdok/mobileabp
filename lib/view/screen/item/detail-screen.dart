              ...
              child: Column(
                children: [
                  Expanded(
                      child: Column(
                    children: [
                      Image.asset('images/icn_item.png',
                  ...
                  Align(
                      ...
                      child: SafeArea(
                        ...
                        child: OutlinedButton(
                            onPressed: () =>
                                _dialogBuilder(context, value.item),
                            child: const Text(
                              "Hapus",
                              style: TextStyle(
                                  color: Colors.red,
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
              'Data yang berkaitan dengan barang ini akan dihapus. Aksi ini TIDAK DAPAT dikembalikan dan akan dicatat pada log sistem.'),
          actions: <Widget>[
            TextButton(
